...
class TargetPred(nn.Module):
    def __init__(self,
        ...
        # self.yaw_pred = nn.Sequential(
            # MLP(in_channels + 2, hidden_dim, hidden_dim), #target-based
        self.yaw_pred = nn.Sequential(
    ...
    def forward(self, feat_in: torch.Tensor, tar_candidate: torch.Tensor, candidate_mask=None):
        ...
        #print("feat_in:", feat_in.shape) #64, 1, 64
        ...
        #print(feat_in_repeat.shape) # 64 2485 66 -> 128, 8492, 72
        ...
        # yaw_pred = self.yaw_pred(feat_in_repeat)
        yaw_pred = self.yaw_pred(feat_in)
        #print(yaw_pred.shape) # 128, n, 1 => 128, 1, 1
        ...
        return tar_candit_prob, tar_offset_mean, yaw_pred
    def loss(self,
