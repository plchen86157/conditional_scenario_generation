...
class AtrOffsetPred(nn.Module):
    def __init__(self,
        ...
        """"""
        super(AtrOffsetPred, self).__init__()
        ...
        # self.atr_offset_mlp = nn.Sequential(
    ...
    def forward(self, feat_in: torch.Tensor):
        ...
        #print("feat_in:", feat_in.shape) #128, 1, 64
        #print("tar_candidate:", tar_candidate.shape) #64, 2485, 2
        feat_in = feat_in.squeeze(1)
        tar_offset_pred = self.atr_offset_mlp(feat_in)                                         # [batch_size, n_tar, 2]
        atr_yaw_pred = self.yaw_pred(feat_in)
        return tar_offset_pred, atr_yaw_pred
    def loss(self,
