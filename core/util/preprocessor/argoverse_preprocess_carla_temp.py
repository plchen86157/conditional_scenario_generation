...
class ArgoversePreprocessor(Preprocessor):
    ...
    def get_obj_feats(self, data, id):
        ...
        topology = np.load("/home/carla/experiments/TNT-Trajectory-Predition/carla_all_data/topology/" + id + ".npy", allow_pickle=True)
        ...
        #print("c:", ctr_line_candts)
        #print("c:", ctr_line_candts.shape) #(12, )
...
if __name__ == "__main__":
    ...
    parser.add_argument("-r", "--root", type=str, default="/home/carla/experiments/TNT-Trajectory-Predition/carla_all_data")
    parser.add_argument("-d", "--dest", type=str, default="/home/carla/experiments/TNT-Trajectory-Predition/carla_all_data")
