            ...
            for data in tqdm(self.test_loader):
                ...
                if not flag:
                    ...
                    for s in range(batch_size):
                        ...
                        import os
                        #if now_scenario not in os.listdir('nuscenes_data/trajectory/' + split + '/'):
                        #    continue
                        ...
                        gyaw = pred_target_point_yaw[s][0][0] * 180 / np.pi# + 90 * np.pi / 180# + ego_rot * np.pi / 180
                        ...
                        tp_gyaw = pred_target_point_yaw[s][0][0] * 180 / np.pi + atr_yaw_pred[s]
                        ...
                        for track_id, remain_df in sce_df.groupby("TRACK_ID"):
                            if str(track_id) == 'ego':
                                ...
                                #print(np.array(remain_df).shape, tp_yaw_v.shape) 
