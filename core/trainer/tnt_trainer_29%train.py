...
class TNTTrainer(Trainer):
    ...
    def test(self,
            ...
            for data in tqdm(self.test_loader):
                ...
                if not only_1_batch_flag:
                    ...
                    for s in range(batch_size):
                        ...
                        plt.xlim(gt_trajectories[now_scenario][-1][0] - 75,
                                    gt_trajectories[now_scenario][-1][0] + 75)
                        plt.ylim(gt_trajectories[now_scenario][-1][1] - 75,
                                    gt_trajectories[now_scenario][-1][1] + 75)
                        ...
                        if right_guess_tp:
                            ...
                            right_guess_tp = "F"
                        title = 'Yaw offset:' + str(round(atr_yaw_pred[s].cpu().numpy()[0] * 180 / np.pi, 1)) + ' TP: ' + right_guess_tp
        ...
        # print("lane change ratio:", round(lane_change_num / lane_change_all, 2), " Real collision:", round(col_lane_change_num / lane_change_all, 2), " Similarity:", round(sim_lane_change_num / col_lane_change_num, 2))
        # print("opposite direction ratio:", round(opposite_direction_num / opposite_direction_all, 2), " Real collision:", round(col_opposite_direction_num / opposite_direction_all, 2), " Similarity:", round(sim_opposite_direction_num / col_opposite_direction_num, 2))
        # print("rear end ratio:", round(rear_end_num / rear_end_all, 2), " Real collision:", round(col_rear_end_num / rear_end_all, 2), " Similarity:", round(sim_rear_end_num / col_rear_end_num, 2))
        # print("junction crossing ratio:", round(junction_crossing_num / junction_crossing_all, 2), " Real collision:", round(col_junction_crossing_num / junction_crossing_all, 2), " Similarity:", round(sim_junction_crossing_num / col_junction_crossing_num, 2))
        ...
        #print(col_lane_change_num, col_opposite_direction_num, col_rear_end_num, junction_crossing_num)
        # if compute_metric:
